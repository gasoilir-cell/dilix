...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_stickers_sticker_pack_owner_earth_id",
        "sticker_pack",
        ["owner_earth_id"],
        schema="stickers",
    )
    op.create_index(
        "ix_stickers_sticker_pack_is_public", "sticker_pack", ["is_public"], schema="stickers"
    )
    ...
    op.create_index(
        "ix_stickers_sticker_owner_earth_id", "sticker", ["owner_earth_id"], schema="stickers"
    )
    ...
    op.create_index(
        "ix_stickers_starred_sticker_user_earth_id",
        "starred_sticker",
        ["user_earth_id"],
        schema="stickers",
    )
    op.create_index(
        "ix_stickers_starred_sticker_sticker_id",
        "starred_sticker",
        ["sticker_id"],
        schema="stickers",
    )
    ...
    op.create_index(
        "ix_stickers_installed_pack_user_earth_id",
        "installed_pack",
        ["user_earth_id"],
        schema="stickers",
    )
    op.create_index(
        "ix_stickers_installed_pack_pack_id", "installed_pack", ["pack_id"], schema="stickers"
    )
    op.create_index(
        "uq_installed_pack",
        "installed_pack",
        ["user_earth_id", "pack_id"],
        unique=True,
        schema="stickers",
    )
    ...
    op.create_index(
        "ix_stories_story_author_earth_id", "story", ["author_earth_id"], schema="stories"
    )
    ...
    op.create_index(
        "ix_story_author_exp", "story", ["author_earth_id", "expires_at"], schema="stories"
    )
    ...
    op.create_index(
        "ix_stories_contact_circle_owner_earth_id",
        "contact_circle",
        ["owner_earth_id"],
        schema="stories",
    )
    op.create_index(
        "ix_stories_contact_circle_member_earth_id",
        "contact_circle",
        ["member_earth_id"],
        schema="stories",
    )
    op.create_index(
        "uq_contact_circle",
        "contact_circle",
        ["owner_earth_id", "member_earth_id", "circle"],
        unique=True,
        schema="stories",
    )
    op.create_index(
        "ix_contact_circle_member",
        "contact_circle",
        ["member_earth_id", "circle"],
        schema="stories",
    )
    ...
    op.create_index(
        "ix_stories_story_view_viewer_earth_id", "story_view", ["viewer_earth_id"], schema="stories"
    )
    op.create_index(
        "uq_story_view",
        "story_view",
        ["story_id", "viewer_earth_id"],
        unique=True,
        schema="stories",
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        "ix_stories_story_view_viewer_earth_id", table_name="story_view", schema="stories"
    )
    ...
    op.drop_index(
        "ix_stories_contact_circle_member_earth_id", table_name="contact_circle", schema="stories"
    )
    op.drop_index(
        "ix_stories_contact_circle_owner_earth_id", table_name="contact_circle", schema="stories"
    )
    ...
    op.drop_index(
        "ix_stickers_installed_pack_pack_id", table_name="installed_pack", schema="stickers"
    )
    op.drop_index(
        "ix_stickers_installed_pack_user_earth_id", table_name="installed_pack", schema="stickers"
    )
    op.drop_table("installed_pack", schema="stickers")
    op.drop_index("uq_starred_sticker", table_name="starred_sticker", schema="stickers")
    op.drop_index(
        "ix_stickers_starred_sticker_sticker_id", table_name="starred_sticker", schema="stickers"
    )
    op.drop_index(
        "ix_stickers_starred_sticker_user_earth_id", table_name="starred_sticker", schema="stickers"
    )
    ...
    op.drop_index(
        "ix_stickers_sticker_pack_is_public", table_name="sticker_pack", schema="stickers"
    )
    op.drop_index(
        "ix_stickers_sticker_pack_owner_earth_id", table_name="sticker_pack", schema="stickers"
    )
